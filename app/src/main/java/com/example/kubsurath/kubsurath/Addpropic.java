...
/**
 * Created by dinesh on 23-Apr-15.
 */
public class Addpropic extends ActionBarActivity {
    ...
    private String URL_FEED = "http://andlog.jobstracer.com/postpropic.php";
    Person person;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addpropic);
    ...
    */
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            HttpPost httppost = new HttpPost("http://andlog.jobstracer.com/postpropic.php");
